...
- ~~[![Integration Test](https://github.com/OverlayFox/casparcg-amcp-go/actions/workflows/casparTest.yml/badge.svg)](https://github.com/OverlayFox/casparcg-amcp-go/actions/workflows/casparTest.yml) verifies package against the latest builds of CasparCG Server `2.4` and `2.5`.~~ Not yet implemented.
